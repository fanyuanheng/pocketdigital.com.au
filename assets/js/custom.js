...
/* Main options */
var	setting = {
	lastDate: '10/22/2013 00:00:00',   //Date format: month/day/year hours:minutes:seconds
	timeZone: +10,                    //GMT +10 or -5
	style:{
		colorStart:'#26B2AE',          //Background color start. Any #hex color, only 6 characters
		colorEnd:'#313D4D',            //Background color end. Any #hex color, only 6 characters
